...
namespace Maticsoft.BuilderIDAL
{
    ...
    public class BuilderIDAL : IBuilder.IBuilderIDAL
    {
        ...
        public string CreatGetList()
        {
            ...
            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// 获得数据列表 Model");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "List<" + ModelSpace + "> GetModelList(string strWhere);");

            strclass.AppendLine(); // 张义超 2015-10-13
            strclass.AppendSpaceLine(2, "/// <summary>");
            strclass.AppendSpaceLine(2, "/// DataTable 转换为 ModelList");
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "List<" + ModelSpace + "> DataTableToList(DataTable dt);"); 

            if (dbType == "Oracle" || dbType == "MySQL")
            {
                strclass.AppendLine();
                strclass.AppendSpaceLine(2, "/// <summary>");
                strclass.AppendSpaceLine(2, "/// 分页获取总数 ");
                strclass.AppendSpaceLine(2, "/// </summary>");
                ...
                strclass.AppendSpaceLine(2, "/// </summary>");
                strclass.AppendSpaceLine(2, "DataSet GetListByPage(string strWhere, string orderby, int pageIndex, int pageSize);");
            }
