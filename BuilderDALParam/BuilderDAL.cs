...
namespace Maticsoft.BuilderDALParam
{
    ...
    public class BuilderDAL : Maticsoft.IBuilder.IBuilderDAL
    {
        ...
        public string GetDALCode(bool Maxid, bool Exists, bool Add, bool Update, bool Delete, bool GetModel, bool List)
        {
            ...
            // strclass.AppendLine("using Maticsoft.DBUtility;//Please add references"); NameSpace
        ...
        public string CreatGetList()
        {
            ...
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "strSql.Append(\" where 1=1 \"+strWhere);");
            strclass.AppendSpaceLine(3, "}");
        ...
        public string CreatGetListByPage()
        {
            ...
            switch (dbobj.DbType)
            {
                ...
                case "SQL2012":
                case "OleDb":
                    #region  SQLServer 张义超 2015-09-15 未测试
                    strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            ...
            strclass.AppendSpaceLine(2, "{");
            // 张义超 2014-11-27  根据控件修改 DbHelperOra添加 GetDataSetPage方法
            strclass.AppendSpaceLine(3, "StringBuilder strSql=new StringBuilder();");
            strclass.AppendSpaceLine(3, "strSql.Append(\"SELECT T.* FROM " + TableName + " T \");");
            strclass.AppendSpaceLine(3, "if (!string.IsNullOrEmpty(strWhere.Trim()))");
            strclass.AppendSpaceLine(3, "{");
            strclass.AppendSpaceLine(4, "strSql.Append(\" WHERE   1=1 \" + strWhere);");
            strclass.AppendSpaceLine(3, "}");
            ...
            strclass.AppendSpaceLine(4, "strSql.Append(\"order by T." + _IdentityKey + " desc\");");
            strclass.AppendSpaceLine(3, "}");
            strclass.AppendSpaceLine(3, "return " + DbHelperName + ".GetDataSetPage(strSql.ToString(), pageIndex, pageSize);");
            strclass.AppendSpaceLine(2, "}"); 
            #endregion
                break;
                default: break;
